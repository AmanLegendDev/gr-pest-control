...
interface GalleryPublishingSectionProps {
  register: UseFormRegister<GalleryFormValues>;
  errors: FieldErrors<GalleryFormValues>;
}

export default function GalleryPublishingSection({
  register,
  errors,
}: GalleryPublishingSectionProps) {
  return (
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-[#64748B]">
              Control whether this gallery item is visible and featured.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4 p-5 sm:p-6">
        ...
        <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-slate-200 p-4 transition hover:border-[#0878E8] hover:bg-blue-50/30">
          ...
          <span className="min-w-0">
            ...
            <span className="mt-1 block text-xs leading-5 text-[#64748B]">
              Active gallery items can be displayed on the public website.
            </span>
          </span>
        </label>
        ...
        <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-slate-200 p-4 transition hover:border-amber-400 hover:bg-amber-50/30">
          ...
          <span className="min-w-0">
            ...
            <span className="mt-1 block text-xs leading-5 text-[#64748B]">
              Feature this image for prominent placements in the gallery.
            </span>
          </span>
        </label>
