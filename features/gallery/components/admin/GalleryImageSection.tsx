...
interface GalleryImageSectionProps {
  ...
  setValue: UseFormSetValue<GalleryFormValues>;
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-[#64748B]">
              Upload the image that will appear in the public gallery.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-5 p-5 sm:p-6">
        ...
        <div>
          ...
          <input
            ...
            aria-describedby={
              errors.image?.alt
                ? "gallery-image-alt-error"
                : "gallery-image-alt-help"
            }
          ...
          {errors.image?.alt ? (
            ...
            <p
              id="gallery-image-alt-help"
              className="mt-1.5 text-xs text-[#64748B]"
            >
              Describe the actual image for accessibility and SEO.
            </p>
          )}
        </div>
      </div>
